...
# Path to tfrecords.
CONFIG.PATH_TO_TFRECORDS = './tfrecords/%s_tfrecords/'
...
CONFIG.MODEL.RESNET_PRETRAINED_WEIGHTS = 'saved_models/resnet50v2_weights_tf_dim_ordering_tf_kernels_notop.h5'
